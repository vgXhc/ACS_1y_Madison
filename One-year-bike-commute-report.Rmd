...
```
Once a year in September, the US Census Bureau publishes the latest annual data from the [American Community Survey (ACS)](https://www.census.gov/programs-surveys/acs/). Included is information about how people commute to work. Transportation planners and advocates often rely on this data. Not so much because it is the one best data, but because we don't have a whole lot of other data about biking. This post will take deep dive into the commuting data for Madison over the past couple years.

Let's start with bike commuting: What's the proportion of people biking to work in the City of Madison, and how has it changed over time?
...
Trips to work account for [less than 20%](https://nhts.ornl.gov/assets/2017_nhts_summary_travel_trends.pdf) of all trips. So is it possible that overall biking is still growing in Madison? Maybe people drive to work, but bike more to the grocery store or for recreation? We do have one source that can help answer this question: The Eco-Counters on the Southwest Path and the Capital City Trail. [Their](https://data-cityofmadison.opendata.arcgis.com/datasets/eco-totem-capital-city-trail-bike-counts) [data](https://data-cityofmadison.opendata.arcgis.com/datasets/eco-totem-southwest-path-bike-counts) doesn't reach back all the way to 2011, but we do have several year's worth of counts:
